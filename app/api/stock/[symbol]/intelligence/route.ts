...
import { getComprehensiveMarketIntelligence, RiskMetrics } from '@/lib/connectors/market-intelligence';
...
// Default risk metrics when no data is available
...
export async function GET(
  ...
  try {
    ...
    // Safely extract risk with fallback
    const riskData: RiskMetrics = marketIntel?.risk || DEFAULT_RISK;
