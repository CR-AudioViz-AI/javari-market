  ...
  return (
    <aside aria-label="Disclaimer" className="mx-auto mt-10 max-w-5xl px-4 pb-10 text-xs leading-relaxed text-gray-400">
      <p>
        ...
        Consider your own research and a licensed financial professional before investing. <Link href="/how-it-works#disclaimers" className="inline-block py-2 underline hover:text-white">Full disclaimers</Link>.
      </p>
